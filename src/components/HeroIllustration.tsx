...
export default function HeroIllustration() {
  ...
  return (
    <div className="relative w-full h-full min-h-[320px] sm:min-h-[420px]">
      ...
      {/* Decorative sakura petals — visible whether or not the user's image loaded */}
      <svg
        aria-hidden
      ...
      {/* User-provided image. Drop into /public/hero-illustration.png to replace the placeholder. */}
      <img
      ...
      {/* Fallback: abstract panel silhouette in coral so the hero never looks empty */}
      {(!loaded || failed) && (
